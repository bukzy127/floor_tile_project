...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.room_height_spin = QDoubleSpinBox(minimum=0.0, maximum=10.0, value=0.0, decimals=2, singleStep=0.05)
        ...
        self.sx_in = QDoubleSpinBox(minimum=-0.5, maximum=0.5, value=0.0, decimals=3, singleStep=0.001)
        self.sy_in = QDoubleSpinBox(minimum=-0.5, maximum=0.5, value=0.0, decimals=3, singleStep=0.001)
